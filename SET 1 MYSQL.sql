...
COUNTRYNAME VARCHAR(50),POPULATION INT,CAPITAL VARCHAR(50));
...
'Brazil',209,'Brasilia'),('Pakistan',193,'Islamabad'),('Nigeria',187,'Abuja'),(
'Bangladesh',163,'Dhaka'),('Russia',143,'Moscow'),('Mexico',128,'Mexico City'),('Japan',126,'Tokyo'),(
'Philippines',102,'Manila'),('Ethiopia',101,'Addis Ababa'),('Vietnam',94,'Hanoi'),('Egypt',93,'Cairo'),(
'Germany',81,'Berlin'),('Iran',80,'Tehran'),('Turkey',79,'Ankara'),('Congo',79,'Kinshasa'),('France',64,'Paris'),(
'United Kingdom',65,'London'),('Italy',60,'Rome'),('South Africa',55,'Pretoria'),('Myanmar',54,'Naypyidaw');
SELECT * FROM COUNTRIES;

/*   Add a couple of countries of your choice  */
INSERT INTO  COUNTRIES VALUES(
'Argentina',289,'Buenos Aires'),('North Korea',278,'Pyongyang'),(
'Uzbekistan',286,'Tashkent');

/*  Change ‘Delhi' to ‘New Delhi' */
ALTER TABLE COUNTRIES ADD PRIMARY KEY (COUNTRYNAME);
...
SHOW FULL COLUMNS FROM BIG_COUNTRIES;
...
balance_stock   */
CREATE TABLE SUPPLIERS(SUPPLIER_ID INT,SUPPLIER_NAME VARCHAR(100),LOCATION VARCHAR(100),PRIMARY KEY(SUPPLIER_ID));
SELECT * FROM SUPPLIERS;
SHOW FULL COLUMNS FROM SUPPLIERS;
DESCRIBE SUPPLIERS; 

CREATE TABLE PRODUCT (PRODUCT_ID INT NOT NULL,PRODUCT_NAME VARCHAR(100) NOT NULL UNIQUE ,
DESCRIPTION VARCHAR(255),SUPPLIER_ID INT,foreign key (SUPPLIER_ID) REFERENCES SUPPLIERS(SUPPLIER_ID));
ALTER TABLE PRODUCT ADD PRIMARY KEY(PRODUCT_ID);
SELECT * FROM PRODUCT;
SHOW FULL COLUMNS FROM PRODUCT;

CREATE TABLE STOCK(ID INT NOT NULL,PRODUCT_ID INT NOT NULL,BALANCE_STOCK INT);
...
SELECT * FROM SUPPLIERS; /* ADD VALUES IN TABLE DIRECTLY AND CLICK APPLY  */
INSERT INTO PRODUCT VALUES(101,'ELECTRONICS','WE ARE PROVIDING ELECTRONIC EQUIPMENTS FOR HOUSEHOLD',1),
(102,'CONSTRUCTION','CONSTRUCTION EQUIPMENT FOR HOUSES AND HUGE APARTMENTS ARE AVAILABLE',2),
(103,'LIGHTS','MODERN LUXUARY LIGHTING ARE AVAILABLE',3);
INSERT INTO STOCK VALUES (1001,101,1500),(1002,102,750),(1003,103,1000);


/*    Modify the supplier table to make supplier name unique and not null  */
ALTER TABLE SUPPLIERS ADD CONSTRAINT SUPPLIER_NAME UNIQUE(SUPPLIER_NAME);
ALTER TABLE SUPPLIERS MODIFY SUPPLIER_NAME VARCHAR(100) NOT NULL;
DESCRIBE SUPPLIERS;
...
CREATE UNIQUE INDEX emp_unique ON emp(emp_no);
